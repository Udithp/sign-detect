...
const LETTERS = [
  { letter:'A', tip:'Closed fist with thumb on the side', img: '/letters/A.png' },
  { letter:'B', tip:'Open palm with thumb tucked across', img: '/letters/B.png' },
  { letter:'C', tip:'Hand curved like a C', img: '/letters/C.png' },
  { letter:'CH', tip:'C handshape moving sideways', img: '/letters/CH.png' },
  { letter:'D', tip:'Index finger up, others touching thumb', img: '/letters/D.png' },
  { letter:'E', tip:'Fingers curled, thumb tucked in', img: '/letters/E.png' },
  { letter:'F', tip:'Index and thumb touch, others up', img: '/letters/F.png' },
  { letter:'G', tip:'Thumb and index pointing sideways', img: '/letters/G.png' },
  { letter:'H', tip:'Index and middle pointing sideways', img: '/letters/H.png' },
  { letter:'I', tip:'Pinky finger pointing up', img: '/letters/I.png' },
  { letter:'J', tip:'Pinky traces a J in the air', motion:true, img: '/letters/J.png' },
  { letter:'K', tip:'Index and middle up, thumb in between', img: '/letters/K.png' },
  { letter:'L', tip:'Thumb and index form an L', img: '/letters/L.png' },
  { letter:'LL', tip:'L handshape moving sideways', img: '/letters/LL.png' },
  { letter:'M', tip:'Three fingers over the thumb', img: '/letters/M.png' },
  { letter:'N', tip:'Two fingers over the thumb', img: '/letters/N.png' },
  { letter:'Ñ', tip:'N handshape with a waving motion', img: '/letters/Ñ.png' },
  { letter:'O', tip:'Fingers and thumb form an O', img: '/letters/O.png' },
  { letter:'P', tip:'K sign pointing downwards', img: '/letters/P.png' },
  { letter:'Q', tip:'G sign pointing downwards', img: '/letters/Q.png' },
  { letter:'R', tip:'Index and middle fingers crossed', img: '/letters/R.png' },
  { letter:'RR', tip:'R handshape moving sideways', img: '/letters/RR.png' },
  { letter:'S', tip:'Closed fist with thumb across fingers', img: '/letters/S.png' },
  { letter:'T', tip:'Thumb tucked under the index finger', img: '/letters/T.png' },
  { letter:'U', tip:'Index and middle fingers together', img: '/letters/U.png' },
  { letter:'V', tip:'Index and middle fingers spread (V)', img: '/letters/V.png' },
  { letter:'W', tip:'Three fingers spread (W)', img: '/letters/W.png' },
  { letter:'X', tip:'Index finger hooked like a hook', img: '/letters/X.png' },
  { letter:'Y', tip:'Thumb & pinky out (hang loose)', img: '/letters/Y.png' },
  { letter:'Z', tip:'Index finger traces a Z in the air', motion:true, img: '/letters/Z.png' },
